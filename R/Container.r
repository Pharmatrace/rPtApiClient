  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`container_id`)) {
        ContainerObject[['container_id']] <- self$`container_id`
      }
      if (!is.null(self$`epc_code`)) {
        ContainerObject[['epc_code']] <- self$`epc_code`
      }
      if (!is.null(self$`label`)) {
        ContainerObject[['label']] <- self$`label`
      }
      if (!is.null(self$`barcode`)) {
        ContainerObject[['barcode']] <- self$`barcode`
      }
      if (!is.null(self$`rf_id`)) {
        ContainerObject[['rf_id']] <- self$`rf_id`
      }
      if (!is.null(self$`quantity`)) {
        ContainerObject[['quantity']] <- self$`quantity`
      }
      if (!is.null(self$`unit`)) {
        ContainerObject[['unit']] <- self$`unit`
      }
      if (!is.null(self$`current_location_id`)) {
        ContainerObject[['current_location_id']] <- self$`current_location_id`
      }
      if (!is.null(self$`owner_stakeholder_id`)) {
        ContainerObject[['owner_stakeholder_id']] <- self$`owner_stakeholder_id`
      }
      if (!is.null(self$`parent_container_id`)) {
        ContainerObject[['parent_container_id']] <- self$`parent_container_id`
      }

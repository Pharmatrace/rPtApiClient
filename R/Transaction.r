  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`timestamp`)) {
        TransactionObject[['timestamp']] <- self$`timestamp`
      }
      if (!is.null(self$`tx_uid`)) {
        TransactionObject[['tx_uid']] <- self$`tx_uid`
      }
      if (!is.null(self$`terms_id`)) {
        TransactionObject[['terms_id']] <- self$`terms_id`
      }
      if (!is.null(self$`transaction_channel`)) {
        TransactionObject[['transaction_channel']] <- self$`transaction_channel`
      }

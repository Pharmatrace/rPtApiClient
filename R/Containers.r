...
Containers <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`offset`, `limit`, `count`, `listing`){
      ...
      if (!missing(`listing`)) {
        stopifnot(is.list(`listing`), length(`listing`) != 0)
        lapply(`listing`, function(x) stopifnot(R6::is.R6(x)))
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`offset`)) {
        ContainersObject[['offset']] <- self$`offset`
      }
      if (!is.null(self$`limit`)) {
        ContainersObject[['limit']] <- self$`limit`
      }
      if (!is.null(self$`count`)) {
        ContainersObject[['count']] <- self$`count`
      }
      if (!is.null(self$`listing`)) {
        ContainersObject[['listing']] <- lapply(self$`listing`, function(x) x$toJSON())
      }
    ...
    fromJSON = function(ContainersJson) {
      ...
      if (!is.null(ContainersObject$`listing`)) {
        self$`listing` <- lapply(ContainersObject$`listing`, function(x) {
    ...
    toJSONString = function() {
       sprintf(
        ...
        self$`limit`,
        self$`count`,
        lapply(self$`listing`, function(x) paste(x$toJSON(), sep=","))
      )
    },
    fromJSONString = function(ContainersJson) {
      ...
      self$`limit` <- ContainersObject$`limit`
      self$`count` <- ContainersObject$`count`
      self$`listing` <- lapply(ContainersObject$`listing`, function(x) Container$new()$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE)))
    }
  )
)

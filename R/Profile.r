  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`first_name`)) {
        ProfileObject[['first_name']] <- self$`first_name`
      }
      if (!is.null(self$`last_name`)) {
        ProfileObject[['last_name']] <- self$`last_name`
      }
      if (!is.null(self$`email`)) {
        ProfileObject[['email']] <- self$`email`
      }
      if (!is.null(self$`twitter_name`)) {
        ProfileObject[['twitter_name']] <- self$`twitter_name`
      }
      if (!is.null(self$`linkedin_name`)) {
        ProfileObject[['linkedin_name']] <- self$`linkedin_name`
      }
      if (!is.null(self$`facebook_name`)) {
        ProfileObject[['facebook_name']] <- self$`facebook_name`
      }
      if (!is.null(self$`picture`)) {
        ProfileObject[['picture']] <- self$`picture`
      }
      if (!is.null(self$`stakeholder_id`)) {
        ProfileObject[['stakeholder_id']] <- self$`stakeholder_id`
      }
      if (!is.null(self$`active`)) {
        ProfileObject[['active']] <- self$`active`
      }

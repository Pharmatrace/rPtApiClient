  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`timestamp`)) {
        TransportObject[['timestamp']] <- self$`timestamp`
      }
      if (!is.null(self$`tx_uid`)) {
        TransportObject[['tx_uid']] <- self$`tx_uid`
      }
      if (!is.null(self$`terms_id`)) {
        TransportObject[['terms_id']] <- self$`terms_id`
      }
      if (!is.null(self$`transaction_channel`)) {
        TransportObject[['transaction_channel']] <- self$`transaction_channel`
      }
